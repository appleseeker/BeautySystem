...
namespace StoreWebSite.Code.MVCExt
{
    ...
    public class userAuthorizedHelper
    {
        ...
        {
            if (!StoreWebSite.Controllers.HomeController.OpenAuth()) return true;
        ...
        /// <returns></returns>
        public static List<KeyValuePair<string, List<StoreWebSite.Models.MenuItem>>> FilterMenu(List<KeyValuePair<string, List<StoreWebSite.Models.MenuItem>>> list)
        {
